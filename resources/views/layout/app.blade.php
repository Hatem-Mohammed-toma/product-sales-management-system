...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/adminlte.rtl.css.map') }}">
    <!--end::Required Plugin(AdminLTE)--><!-- apexcharts -->
    <link rel="stylesheet" href="{{ asset('css/adminlte.rtl.min.css') }}">
    <!--end::Required Plugin(AdminLTE)--><!-- apexcharts -->
    <link rel="stylesheet" href="{{ asset('css/adminlte.rtl.min.css.map') }}">
    <!--end::Required Plugin(AdminLTE)--><!-- apexcharts -->
...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary" dir="rtl"> <!--begin::App Wrapper-->
    <div class="app-wrapper"> <!--begin::Header-->
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark"> <!--begin::Sidebar Brand-->
            <div class="sidebar-brand"> <!--begin::Brand Link-->
                {{-- <span class="brand-text fw-light brand-link">سنترال</span> <!--end::Brand Text--> --}}
                <span class="px-3 py-1 bg-warning text-dark text-sm fw-bold rounded-pill shadow-sm">
                    كاش أوت
                </span>
            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2"> <!--begin::Sidebar Menu-->
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu"
                        ...
                        {{-- البيع --}}
                        <li class="nav-item">
                            <a href="{{ route('sales.page') }}" class="nav-link">
    ...
    {{-- <script src="{{ asset('js/adminlte.js.map') }}"></script> <!--end::Required Plugin(AdminLTE)--><!--begin::OverlayScrollbars Configure-->
    <script src="{{ asset('js/adminlte.min.js') }}"></script> <!--end::Required Plugin(AdminLTE)--><!--begin::OverlayScrollbars Configure-->
    <script src="{{ asset('js/adminlte.min.js.map') }}"></script> <!--end::Required Plugin(AdminLTE)--><!--begin::OverlayScrollbars Configure--> --}}
